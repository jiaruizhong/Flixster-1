...
<img src="https://github.com/thualing/Flixster/blob/master/Flix(DetailActivity.gif" width=250><br>

### Notes

- The video player is not working in my emulator. Only sound would be playing while clicking the play button. 
- I hide my Youtube API key 
